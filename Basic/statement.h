 ...
 */
   ...
   virtual void parseState(TokenScanner & scanner, string & line) = 0;
...
public:
	REMstate() = default;
	virtual ~REMstate() = default;
	virtual void execute(EvalState & state);
	virtual void parseState(TokenScanner &, string &);
private:
};
